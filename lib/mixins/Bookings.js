...
function getAgendaBookings(params){
...
function createRecurringBooking(params){
    return this._post('bookings/recurring', {recurrence: params});
}

function getOccurences(collectionId){
    return this._get('bookings/' + collectionId);
}
...
module.exports = {
    ...
    getAgendaBookings: getAgendaBookings,
